...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/elasticsearch-dbapi-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12003&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/elasticsearch-dbapi-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `elasticsearch-dbapi` can be installed with:

```
conda install elasticsearch-dbapi
```

It is possible to list all of the versions of `elasticsearch-dbapi` available on your platform with:
